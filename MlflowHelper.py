...
def get_active_artifact_dir():
    ...
    # artifact_uri is like mlflow-artifacts:/<exp_id>/<run_id>/artifacts
    ...
    if artifact_uri.startswith("file://"):
        ...
        # Note, must be a local file path. 
        # Need to create the experiment from python, not from server ui
        # otherwise artifact_uri will be like mlflow-artifacts:/...
        # saving files to the path will not show up in server ui
        raise ValueError("Active artifact URI is not a local file path.")
